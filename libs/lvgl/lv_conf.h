...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "MiniCommon.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (MiniCommon_millis())    /*Expression evaluating to current system time in ms*/
...
#if LV_USE_FS_FATFS
    #define LV_FS_FATFS_LETTER 'mini:'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
