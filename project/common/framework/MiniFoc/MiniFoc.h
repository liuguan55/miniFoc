...
#include "pid.h"
#include "foc_utils.h"
#include "common/framework/MiniFoc/sensor/Sensor.h"
#include "common/framework/MiniFoc/driver/driver.h"
#include "common/framework/MiniFoc/current/Current.h"
#include "focConf.h"
...
typedef enum
{
  Type_voltage = 0, //!< Torque control using voltage
