...
void EmptyUARTDriver::begin(uint32_t b) {UNUSED(b);}
void EmptyUARTDriver::begin(uint32_t b, uint16_t rxS, uint16_t txS) {UNUSED(b);UNUSED(rxS);UNUSED(txS);}
void EmptyUARTDriver::end() {}
void EmptyUARTDriver::flush() {}
bool EmptyUARTDriver::is_initialized() { return false; }
void EmptyUARTDriver::set_blocking_writes(bool blocking) {UNUSED(blocking);}
...
size_t EmptyUARTDriver::write(uint8_t c) { UNUSED(c); return 0; }
