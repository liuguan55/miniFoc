/*
 * @Author: liuguan
 * @Date: 2022-06-14 15:44:19
 * @LastEditors: liuguan
 * @LastEditTime: 2022-07-26 21:55:42
 * @FilePath: /esp8266-rtos/src/lettershell/shell_cfg.h
 * @Description: 
 * 
 ...
 */
#define     SHELL_USING_CMD_EXPORT      1//0

/**
 * @brief 是否使用shell伴生对象
 *        一些扩展的组件(文件系统支持，日志工具等)需要使用伴生对象
 */
#define     SHELL_USING_COMPANION       1//0
 ...
 */
#define     SHELL_HELP_LIST_USER        1//0
 ...
 */
#define     SHELL_GET_TICK()           MiniCommon_millis()
