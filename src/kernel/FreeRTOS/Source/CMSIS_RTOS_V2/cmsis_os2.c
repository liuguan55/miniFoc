...
#include "kernel/FreeRTOS/CMSIS_RTOS_V2/cmsis_os2.h"                  // ::CMSIS:RTOS2
#include "driver/chip/CMSIS/cmsis_compiler.h"             // Compiler agnostic definitions

#include "kernel/FreeRTOS/FreeRTOS.h"                   // ARM.FreeRTOS::RTOS:Core
#include "kernel/FreeRTOS/task.h"                       // ARM.FreeRTOS::RTOS:Core
#include "kernel/FreeRTOS/event_groups.h"               // ARM.FreeRTOS::RTOS:Event Groups
#include "kernel/FreeRTOS/semphr.h"                     // ARM.FreeRTOS::RTOS:Core

#include "kernel/FreeRTOS/CMSIS_RTOS_V2/freertos_mpool.h"             // osMemoryPool definitions
#include "kernel/FreeRTOS/CMSIS_RTOS_V2/freertos_os2.h"               // Configuration check and setup
