...
# If true, `todo` and `todoList` produce driver, else they produce nothing.
todo_include_todos = True


# -- Options for HTML driver ----------------------------------------------
...
# -- Options for manual page driver ---------------------------------------
