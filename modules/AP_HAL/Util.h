...
public:
     ...
     */
    virtual void set_system_clock(uint64_t time_utc_usec) { UNUSED(time_utc_usec);}
    ...
    /*
      ...
      terminated
     */
    virtual bool get_system_id(char buf[40]) {  UNUSED(buf); return false; }
